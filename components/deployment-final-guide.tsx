...
import Download from "lucide-react/dist/icons/Download"
import ExternalLink from "lucide-react/dist/icons/ExternalLink"
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>
                **TRÈS IMPORTANT :** Lors de la configuration du projet sur Vercel, allez dans "Environment Variables"
                et ajoutez les clés API PayPal et Resend que vous avez récupérées précédemment :
